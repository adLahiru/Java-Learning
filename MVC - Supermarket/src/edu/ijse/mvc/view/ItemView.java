...
public  void loadTable(){
    try{
        ...
        ArrayList<ItemDto> itemDtos = itemController.gettAllItem();
        for(ItemDto itemDto :itemDtos){
            itemDto.toString();
            Object[] rawdata ={itemDto.getCode(),itemDto.getDescription(),itemDto.getPackSize(),itemDto.getUnitPrice(),itemDto.getQoh()};
            dtm.addRow(rawdata);
        }
    }catch(Exception e){
        e.printStackTrace();
...
public void deleteItem(){
    try{
        itemController.deleteItem(txtCode.getText());
        loadTable();
        clearForm();
    }catch(Exception e){
        clearForm();
